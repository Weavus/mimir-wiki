...
- [x] Decide whether `processing.writer_workers` needs a real writer queue or
  should be removed from MVP config until needed. It is documented as reserved;
  MVP writes remain synchronous and deterministic.
